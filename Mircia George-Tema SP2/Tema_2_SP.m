% Tema 2 - SP - numarul din lista = 11, deci vom avea un semnal dreptugnhiular
% cu perioada P=40 si numarul de coeficienti N = 50 si durata semnalului
% D=11
P=40;                                                       %P e perioada semnalului
D=11;                                                        %un factor de umplere 1 din 40 este egal cu 2,5%, deci durata impulsului e 2,5% din perioada
...
x=0.5+0.5*square(2*pi*t/P,2.5);                             %am realizat semnalul dreptunghiular cu factorul de umplere 2,5% 
                                                            %corespunzator lui D=11 din P=40, deoarece in cazul semnalului
